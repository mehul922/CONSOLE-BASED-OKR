...
class Employee {
    private String empId, name, role, dept;
    protected double rating;

    public Employee(String empId, String name, String role, String dept, String reviewer) {
        this.empId = empId; this.name = name; this.role = role; this.dept = dept;
    }
